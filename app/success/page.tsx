...
export default function SuccessPage({ patientId, fullName }: SuccessPageProps) {
        ...
        <div className="w-full max-w-md text-center space-y-8">
          ...
          <div className="rounded-2xl bg-zinc-50 dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 p-5 text-left space-y-3">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
              Book an appointment with one of our physicians. We'll match you with the right specialist based on your intake form.
            </p>
          </div>

          {/* CTA button */}
          <button
            onClick={() => router.push(`/appointments/${patientId}`)}
          ...
          <p className="text-xs text-zinc-400 dark:text-zinc-600">
            ...
            <a href="mailto:support@carepulse.com" className="text-primary underline hover:text-zinc-600 dark:hover:text-zinc-400 transition-colors">
