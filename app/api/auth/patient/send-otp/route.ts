            ...
            sendEmail({
                ...
                html: `
                    <div style="font-family:sans-serif;max-width:480px;margin:auto;padding:32px;">
                        <h2 style="color:#18181b;">Your login code</h2>
                        <p style="color:#71717a;">Hi ${patient.fullName},</p>
                        <p style="color:#71717a;">Use this code to sign in to ${hospital.name} patient portal:</p>
                        ...
                        <p style="color:#71717a;font-size:13px;">Expires in 10 minutes.</p>
                    </div>
                `,
            }),
