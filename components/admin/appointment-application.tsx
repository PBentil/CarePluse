...
export function AppointmentActions({ appointment, onSuccess }: AppointmentActionsProps) {
                ...
                <div className="space-y-5">
                    <div className="rounded-xl bg-emerald-50 dark:bg-emerald-950 border border-emerald-100 dark:border-emerald-900 p-4 space-y-1">
                        ...
                        <p className="text-xs text-emerald-600 dark:text-emerald-400">
                            {appointment.doctor.name} · {new Date(appointment.date).toLocaleDateString("en-GB", {
