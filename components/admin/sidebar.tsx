...
import {LayoutDashboard, Users, Calendar, LogOut, Stethoscope, FlaskConical, Pill, Tablets, Package} from "lucide-react"
...
const navItems = [
    ...
    { label: "Drug Catalogue", href: "/admin/drugs",         icon: Tablets },
