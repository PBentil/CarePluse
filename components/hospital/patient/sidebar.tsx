...
import { LayoutDashboard, Calendar, FlaskConical, Pill, Package, PlusCircle, LogOut } from "lucide-react"
...
export function PatientSidebar() {
    ...
    const navItems = [
        { label: "Dashboard",     href: `/${slug}/patient/dashboard`,     icon: LayoutDashboard },
        { label: "Appointments",  href: `/${slug}/patient/appointments`,  icon: Calendar },
        { label: "Book Appointment", href: `/${slug}/patient/book`, icon: PlusCircle },
        { label: "Lab Tests",     href: `/${slug}/patient/lab-tests`,     icon: FlaskConical },
        { label: "Prescriptions", href: `/${slug}/patient/prescriptions`, icon: Pill },
        { label: "My Orders",     href: `/${slug}/patient/orders`,        icon: Package },
    ]

    const handleLogout = async () => {
        await fetch(`/api/${slug}/patient/logout`, { method: "POST" })
