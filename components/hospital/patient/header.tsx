...
export function PatientHeader() {
    ...
    const getTitle = () => {
        ...
        const titles: Record<string, string> = {
            dashboard: "Dashboard", appointments: "My Appointments", "lab-tests": "My Lab Tests",
            prescriptions: "My Prescriptions", orders: "My Orders", payment: "Payment",
        }
        return titles[last ?? ""] ?? "Patient Portal"
    }
